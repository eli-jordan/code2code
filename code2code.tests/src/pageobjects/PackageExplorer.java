...
public class PackageExplorer
{
   ...
   {
      SWTBotView packageExplorerView = Driver.bot().viewByTitle("Package Explorer");

      Tree projectsTree = (Tree) new ChildrenControlFinder(packageExplorerView.getWidget()).findControls(
         WidgetMatcherFactory.widgetOfType(Tree.class)).get(0);
