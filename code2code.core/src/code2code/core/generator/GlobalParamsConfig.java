...
//
//   public GlobalParamsConfig(OldGenerator generator) throws Exception
//   {
//
...
//         processedParams = templateEngine.processMap(generator, FileUtils.loadProperties(file.getContents()),
