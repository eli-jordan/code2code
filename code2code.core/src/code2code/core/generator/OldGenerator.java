...
//   private final File m_generatorFolder;
//
...
//
//   private final List<OldGenerator> m_nestedGenerators;
//
...
//    * @throws Exception
//    */
//   private OldGenerator(IFolder folder) throws Exception
//   {
...
//    * @throws Exception
//    */
//   public static OldGenerator fromFolder(IFolder folder) throws Exception
//   {
//      return new OldGenerator(folder);
//   }
//
...
//
//      for (OldGenerator nestedGenerator : m_nestedGenerators)
//      {
